...
Where the files go is the same for every camera and is set under Settings ▸ Recordings.</source>
        <translation>両方を入れると 1 つのバッファが両方を兼ねます。イベントの録画はアーカイブから切り出されるので、カメラへ余分な接続は開きません。
...
<context>
    ...
    <message>
        ...
        <translation>ffmpeg が入っていないため、連続録画は使えません。</translation>
    </message>
    <message>
